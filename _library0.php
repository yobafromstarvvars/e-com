<div class="library-0-container">
    <img class="signed-out-image" src="<?php echo $libraryLoggedout ?>" alt="Logged out"/>
    ...
    <div class="signedout-buttons-container">
        ...
        <a href="<?php echo $gotoSignUp?>" class="signup-button">
            <span class="material-icons sign-up-button-icon">account_circle</span>
            <span class="sign-up-button-text">Sign Up</span>
        </a>
    </div>
</div>